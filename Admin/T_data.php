        ...
        <div class="row">
          <div class="col-lg-8 col-6">
              ...
              <div class="card-header">
                <h3 class="card-title">From input Data HRD</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="proses_tdata.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nama">Nama</label>
                    <input type="text" class="form-control" name="nama_hrd" placeholder="Masukan Nama">
                  </div>
                  <div class="form-group">
                    <label>Alamat</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="TTL" placeholder="Masukan Tanggal Lahir">
                  </div>
                  <div class="form-group">
                    <label>Agama</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="no_telp" placeholder="Masukan No Telepon">
                  </div>
                  <div class="form-group">
                    <label>Jenis Kelamin</label>
                    <select name="jk_hrd" id="jk" class="form-control">
