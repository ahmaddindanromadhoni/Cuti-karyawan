  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="index.php" class="d-block"><?= $d['nama_adm']; ?></a>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg col-6">
            ...
            <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  <?php
                  $no = 1;
                    $user = mysqli_query($koneksi, "SELECT * FROM employee ORDER BY nik DESC");
                  ...
                  <tr>
                    ...
                    <td><?= $d['alamat']; ?></td>
                    <td>
                      <a href="hapus_karyawan.php?nik=<?=$d['nik']; ?>" class="btn btn-danger"><i class="fas fa-times-circle"></i></a>
                      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal<?= $d['nik'] ?>"><i class="fas fa-info-circle"></i></button>
                    </td>
                  </tr>
                  <!-- Modal -->
           <div class="modal fade" id="exampleModal<?= $d['nik'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="row">
                            <div class="form-group col-sm-6">
                              ...
                              <input type="text" class="form-control" id="recipient-name" value="<?= $d['jabatan'] ?>" readonly>
                            </div>
                            <div class="form-group col-sm-6">
                              <label for="recipient-name" class="col-form-label">Jenis Kelamin :</label>
                              <input type="text" class="form-control" id="recipient-name" value="<?= $d['jk_emp'] ?>" readonly>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="recipient-name" value="<?= $d['telp_emp'] ?>" readonly>
                          </div>
                        </div>
