          ...
          <div class="col-lg col-6">
            ...
            <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  <tbody>
                    <?php
                    $no = 1;
                    $Sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.nik=employee.nik AND 
                    ...
                    <tr>
                      ...
                      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal<?= $d['no_cuti'] ?>"><i class="fas fa-info-circle"></i></button>
                        <a href="reviewApp.php?no=<?= $d['no_cuti'];?>" class="btn btn-primary"><i class="fa fa-check-circle"></i></a></td>
                      </td>
                    </tr>
                    <!-- Modal -->
