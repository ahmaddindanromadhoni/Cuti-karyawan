<?php
  ...
  $user = mysqli_query($koneksi, "SELECT * FROM employee");
  $u = mysqli_num_rows($user);

  $cuti = mysqli_query($koneksi, "SELECT * FROM cuti");
  $d = mysqli_num_rows($cuti);
  
  $app = mysqli_query($koneksi, "SELECT * FROM cuti WHERE stt_cuti='Menunggu Approval'");
  $t = mysqli_num_rows($app);
        ...
        <div class="row">
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-primary">
              ...
              <a href="app_cuti.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-6">
            <!-- small box -->
          ...
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="dataCuti.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
