              ...
              <form class="form-horizontal" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label>NIK</label>
                    <input type="number" class="form-control" name="nik" value="<?= $d['nik']?>" readonly>
                  </div>
                  <div class="form-group">
                    <label>Nama</label>
                    <input type="text" class="form-control" name="nama_emp" value="<?= $d['nama_emp']?>" readonly>
                  </div>
                  <div class="col-sm-12">
                    <div class="row">
                ...
                <div class="row">
                  <div class="form-group col-sm-6">
                    <label>Telepon</label>
                    <input type="text" class="form-control" name="telp_emp"value="<?= $d['telp_emp']?>" readonly></input>
                  </div>
                  <div class="form-group col-sm-6">
                    <label>Password</label>
                    <input type="text" class="form-control" name="password" value="<?= $d['password']?>" readonly></input>
                  </div>
                </div>
                </div>
                  <div class="form-group">
                    <label>Alamat</label>
                    <textarea type="text" class="form-control" rows="3" name="alamat" readonly><?= $d['alamat']?></textarea>
                  </div>
                  <div class="form-group">
                    <a href="update_profil.php" class="btn btn-primary">Update Profil</a>
                  </div>
              </form>
              <?php } ?>
            </div>
