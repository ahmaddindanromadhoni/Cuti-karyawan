<?php
    ...
    $data = mysqli_query($koneksi, "SELECT * FROM cuti WHERE nik='$nik' AND stt_cuti='Menunggu Approval'");
    $b = mysqli_num_rows($data);
    $re = mysqli_query($koneksi, "SELECT * FROM cuti WHERE nik='$nik' AND stt_cuti='Rejected'");
    $c = mysqli_num_rows($re);
    $app = mysqli_query($koneksi, "SELECT * FROM cuti WHERE nik='$nik' AND stt_cuti='Approved'");
    $a = mysqli_num_rows($app);
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <h3>SELAMAT DATANG <strong><?php echo strtoupper($_SESSION['a_global']->nama_emp);  ?></strong></h3>
        ...
        <div class="row">
          <div class="col-lg-4 col-6">
            ...
            <div class="small-box bg-primary">
              ...
              <a href="cuti_approved.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <div class="small-box bg-success">
              ...
              <a href="cuti_wait.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-4 col-6">
            <!-- small box -->
            <div class="small-box bg-danger">
              ...
              <a href="cuti_reject.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
        </div>
            </div>
