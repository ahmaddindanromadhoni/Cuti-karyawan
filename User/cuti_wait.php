  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Cuti Menunggu Approval</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
        <hr>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-lg col-6">
             ...
             <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                $no=1;
                    $Sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.nik=employee.nik AND cuti.stt_cuti='Menunggu Approval'
                ...
                ?>
                  <tr>
                    ...
                    <td class="text-center"><?= $data['no_cuti'];?></td>
                    <td class="text-center"><?= IndonesiaTgl($data['tgl_pengajuan']) ;?></td>
                    <td class="text-center"><?= IndonesiaTgl($data['tgl_awal']);?></td>
                    <td class="text-center"><?= IndonesiaTgl($data['tgl_akhir']);?></td>
                    <td class="text-center"><?= $data['stt_cuti'];?></td>
                    <td class="text-center">
                      <a onclick="return confirm('Apakah anda yakin akan membatalkan pengajuan cuti No. <?php echo $data['no_cuti'];?>?');" href="hapus_cuti.php?no_cuti=<?= $data['no_cuti'];?>"class="btn  btn-danger"><i class="fas fa-times-circle"></i></a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
