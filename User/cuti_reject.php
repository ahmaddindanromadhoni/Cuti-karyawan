...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="index3.index.php" class="brand-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Data Cuti Rejected</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
        <hr>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg col-6">
             ...
             <table id="example1" class="table table-bordered table-striped text-center">
                  ...
                  <tbody>
                    <?php
                        $no = 1;
                        $Sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.nik=employee.nik AND cuti.stt_cuti ='Rejected'
                  ...
                  <tr>
                    <td><?= $no++; ?></td>
                    <td><?= $data['no_cuti'];?></td>
                    <td><?= IndonesiaTgl($data['tgl_pengajuan']) ;?></td>
                    <td><?= IndonesiaTgl($data['tgl_awal']);?></td>
                    <td><?= IndonesiaTgl($data['tgl_akhir']);?></td>
                    <td><?= $data['stt_cuti'];?></td>
                    <td>
                      <a href="hapus_reject.php?no_cuti=<?= $data['no_cuti'];?>" class="btn btn-danger"><i class="fas fa-times-circle"></i></a>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Rejected</h5>
                  ...
                  <div class="modal-body">
                    <form>
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Keterangan Reject :</label>
                            <textarea type="text" class="form-control" id="recipient-name" readonly><?= $data['ket_reject'] ?></textarea>
                          </div>
                        </div>
